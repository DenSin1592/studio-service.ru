            ...
            <div class="col-xxl-10 offset-xxl-1">
                ...
                <div class="faq-accordion accordion" id="faq-accordion">
                    ...
                    <div class="card-accordion">
                        ...
                        <div id="faq-collapse-{{$element->id}}" class="card-accordion-content collapse @if($loop->first) show @endif" aria-labelledby="faq-heading-{{$element->id}}" data-parent="#faq-accordion">
                            <div class="row">
