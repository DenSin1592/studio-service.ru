...
@section('content')
    <div class="node-list element-list-wrapper" data-sortable-wrapper="">
        ...
        @include('admin.shared.resource_list.sorting._commit', ['updateUrl' => route(\App\Http\Controllers\Admin\ServicesController::ROUTE_UPDATE_POSITIONS), 'reloadUrl' => route(\App\Http\Controllers\Admin\CompetenciesController::ROUTE_INDEX)])

        <div>
            <a href="{{ route(\App\Http\Controllers\Admin\ServicesController::ROUTE_CREATE) }}" class="btn btn-success btn-xs">Добавить услугу</a>
        </div>
    </div>
@stop
