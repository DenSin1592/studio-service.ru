<li style="width: 100%;" data-element-list="element" data-element-key="{{ $key }}"
    class="content-block-element {{{ (\Request::old("{$relation}.{$key}.full_info") == 1 || !$element->exists) ? 'show-full-info' : '' }}}">
    ...
    <div class="full-info">
        ...
        <div class="field-hint-block">Рекомендуемый размер изображения - 558х383 px</div>
