    ...
    $(function () {
        ...
        window.tinymceInit = () => {
            ...
            let initData = {
                ...
                forced_root_block : "",
                menubar: false,
                plugins: "image,link,code,table, youtube",
                toolbar: "undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify |  bullist numlist outdent indent | table link unlink image | removeformat code | youtube",
                convert_urls: false,
                relative_urls: true,
                language : "ru",
                theme: "modern",
