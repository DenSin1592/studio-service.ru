...
use App\Services\FormProcessors\Service\SubProcessor\Projects;
use App\Services\FormProcessors\Service\SubProcessor\Reviews;
    ...
    public function register()
    {
        ...
        $this->app->bind(
            ...
            function () {
                ...
                $formProcessor->addSubProcessor(\App(\App\Services\FormProcessors\Offer\SubProcessor\FaqQuestions::class));
                $formProcessor->addSubProcessor(\App(\App\Services\FormProcessors\Offer\SubProcessor\BeforeAfterImages::class));
                $formProcessor->addSubProcessor(\App(\App\Services\FormProcessors\Offer\SubProcessor\Reviews::class));
                $formProcessor->addSubProcessor(\App(\App\Services\FormProcessors\Offer\SubProcessor\Projects::class));
                return $formProcessor;
            }
        );
